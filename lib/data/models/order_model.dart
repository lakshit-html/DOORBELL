...
/// A line item stored inside the order document (denormalised snapshot).
class OrderItem {
  const OrderItem({
...
class OrderModel {
  ...
  /// Scheduled delivery slot chosen by the customer. Null means ASAP.
  final DeliverySlot? scheduledSlot;
  ...
  factory OrderModel.fromMap(String id, Map<String, dynamic> map) => OrderModel(
        ...
        deliveryAddress: AddressModel.fromMap(
            (map['deliveryAddress'] as Map<String, dynamic>?) ?? const {}),
        couponCode: map['couponCode'] as String?,
        razorpayPaymentId: map['razorpayPaymentId'] as String?,
        scheduledSlot: DeliverySlot.fromString(map['scheduledSlot'] as String?),
  ...
  Map<String, dynamic> toMap() => {
        ...
        'shopId': shopId,
        'riderId': riderId,
        'products': items.map((e) => e.toMap()).toList(),
        'subtotal': subtotal,
        ...
        'scheduledSlot': scheduledSlot?.name,
